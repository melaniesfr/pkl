  ...
  return (
    <View style={styles.container}>
      <View style={styles.card}>
        <TouchableOpacity style={{ position: 'relative', flexDirection: 'row', marginBottom: 10 }} onPress={() => navigation.navigate('BahasaUser')}>
          <Icon
        ...
        <TouchableOpacity style={{ position: 'relative', flexDirection: 'row', marginTop: 10 }} onPress={() => navigation.navigate('TentangUser')}>
          <Icon
