        ...
        <View style={styles.container}>
          <View style={styles.card}>
            <TouchableOpacity style={{ alignItems: 'center', justifyContent: 'center', marginBottom: 20 }} onPress={selectImage}>
              { avatarSource === '' ? <Image source={{uri: assets.images.IMNoImage}} style={{ width: 150, height: 150, resizeMode: 'contain' }} /> : null }

              { avatarSource !== '' ? <Image source={{uri: assets.baseURL + `images/${imgSource}`}} style={{ width: 150, height: 150, resizeMode: 'contain' }} /> : null }
